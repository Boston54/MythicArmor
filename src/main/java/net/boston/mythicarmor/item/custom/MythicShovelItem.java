...
public class MythicShovelItem extends ShovelItem implements ColorableMythicItem {
    public MythicShovelItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public static void onBlockBreak(final BlockEvent.BreakEvent event) {
        ...
        if (!(itemStack.getItem() instanceof MythicShovelItem)) return;
